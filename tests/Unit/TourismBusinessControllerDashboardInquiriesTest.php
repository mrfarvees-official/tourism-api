...
class TourismBusinessControllerDashboardInquiriesTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_dashboard_reports_recent_inquiries(): void
    {
        Tenant::query()->create([
            'key' => 'lanka-trails',
            'name' => 'Lanka Trails',
        ...
        $this->assertSame('new', $payload['data']['recent_inquiries'][0]['status']);
    }
}
